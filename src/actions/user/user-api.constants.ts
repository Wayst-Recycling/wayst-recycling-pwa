...
export const CHANGE_PASSWORD_CONFIRM_PASSWORD_KEY = 'confirmPassword';

export const EDIT_PROFILE_PHONE_KEY = 'phone';
export const EDIT_PROFILE_DIAL_CODE_KEY = 'dialCode';
